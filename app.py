...
cn_headers = [
    ...
    '(分录)物料#编码', '(分录)物料#名称(Null)', '(分录)员工#编码', '(分录)员工#名称(Null)', 
    '(分录)客户#编码', '(分录)客户#名称(Null)', '(分录)部门#编码', '(分录)部门#名称(Null)', 
    '(分录)供应商#编码', '(分录)供应商#名称(Null)', '(分录)NL剧集#编码', '(分录)NL剧集#名称(Null)', 
    '(分录)海南剧集#编码', '(分录)海南剧集#名称(Null)', 
    '*(分录)币别#编码', '(分录)币别#名称', '*(分录)汇率类型#编码', '(分录)汇率类型#名称', '(分录)汇率', 
    '(分录)单位#编码', '(分录)单位#名称', '(分录)单价', '(分录)数量', '(分录)原币金额', 
    '(分录)借方金额', '(分录)贷方金额', '(分录)结算方式#编码', '(分录)结算方式#名称', 
